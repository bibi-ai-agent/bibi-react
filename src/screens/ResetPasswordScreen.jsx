        ...
        {done ? (
          ...
          <div style={{ marginTop:16 }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
              <input type="password" placeholder="Yeni şifre (min 6 karakter)" value={password} onChange={e=>setPassword(e.target.value)} style={inp}/>
              <input type="password" placeholder="Şifre tekrar" value={password2} onChange={e=>setPassword2(e.target.value)} style={inp}/>
